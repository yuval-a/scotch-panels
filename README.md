...
once the panel is opened or closed, that element will stay "fixed" and won't be "pushed" by the panel.
It works by implementing a similar translation/animation to the panel for the "fixed" element - only to the opposite direction,
